...
public class AutoDefault extends ParallelCommandGroup {
  ...
  public AutoDefault(
    ...
    addCommands(
      new SwerveAutoGo(swerveSubsytem, Limelight.kReef, false, false)
    //   new StateAutoDefault(algaeGrabberSubsystem, coralGrabberSubsystem, elevatorSubsystem)
    );
  }
}
