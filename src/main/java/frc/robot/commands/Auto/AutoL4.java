...
public class AutoL4 extends ParallelCommandGroup {
  ...
  public AutoL4(
    ...
    addCommands(
      new SwerveAutoGo(swerveSubsytem, Limelight.kReef, true, true),
      new StateAuto(algaeGrabberSubsystem, coralGrabberSubsystem, elevatorSubsystem, ElevatorState.kL2, CoralGrabberState.kDefult, AlgaeGrabberState.kDefult)
    );
  }
}
