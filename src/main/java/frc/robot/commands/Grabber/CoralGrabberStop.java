...
public class CoralGrabberStop extends Command {
  private CoralGrabberSubsystem coralGrabberSubsystem;
  private CoralGrabberAction coralGrabberAction;
  /** Creates a new CoralGrabberStop. */
  public CoralGrabberStop(
  ...
  public void initialize() {
    if(coralGrabberAction == CoralGrabberAction.kFwd){
      coralGrabberSubsystem.setGrabberAction(CoralGrabberAction.kFwd);
    }
    if(coralGrabberAction == CoralGrabberAction.kRev){
      coralGrabberSubsystem.setGrabberAction(CoralGrabberAction.kRev);
    }
    if(coralGrabberAction == CoralGrabberAction.kStop){
