...
public class CoralAngleNoraml extends Command {
  private CoralGrabberSubsystem coralGrabberSubsystem;
  private CoralGrabberAngleAction coralGrabberAngleAction;

  /** Creates a new GrabberNormal. */
  public CoralAngleNoraml(
      CoralGrabberSubsystem coralGrabberSubsystem,
      CoralGrabberAngleAction coralGrabberAngleAction) {
    // Use addRequirements() here to declare subsystem dependencies.
    this.coralGrabberSubsystem = coralGrabberSubsystem;
    this.coralGrabberAngleAction = coralGrabberAngleAction;
  ...
  public void initialize() {
    coralGrabberSubsystem.setAngleAction(coralGrabberAngleAction);
  }
  ...
  public void end(boolean interrupted) {
    ...
    coralGrabberSubsystem.setAngleHold();
  }
