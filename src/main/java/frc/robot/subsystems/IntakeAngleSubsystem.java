...
public class IntakeAngleSubsystem extends SubsystemBase {
  ...
  private SparkAbsoluteEncoder IntakeAngleAbsEncoder = IntakeAngleMotor.getAbsoluteEncoder();
  ...
  public IntakeAngleSubsystem() {
    ...
    // IntakeAngleEncoder.setPosition(IntakeAngleAbsEncoder.getPosition());
  ...
  public double getIntakeAbsPosition() {
    return IntakeAngleAbsEncoder.getPosition();
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Intake Position", getIntakePosition());
    // SmartDashboard.putNumber("Intake Abs Position", getIntakeAbsPosition());
  }
}
